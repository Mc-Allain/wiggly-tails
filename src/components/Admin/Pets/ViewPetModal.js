...
class ViewPetModal extends Component {
  ...
  onSubmit = () => {
    ...
    if (this.validForm({ errors })) {
      ...
      axios
        .post(
          "https://princemc.heliohost.us/veterinaryClinic/updatePet.php",
          record
        )
        .then(() => {
          onRefresh();
                          ...
                          {submitted || deleting || deleted ? (
                            ...
                            <React.Fragment>
                              <select
                                className={
                                  "zi-10 " +
                                  this.inputFieldClasses(errors.ownerId)
                                }
                                name="ownerId"
                                value={record.ownerId}
                                onChange={this.onChangeRecord}
  ...
  onDelete = () => {
    ...
    axios
      .post(
        "https://princemc.heliohost.us/veterinaryClinic/deletePetEmployee.php",
        record
      )
