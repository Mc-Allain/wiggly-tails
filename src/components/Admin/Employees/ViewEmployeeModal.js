...
class ViewEmployeeModal extends Component {
  ...
  componentDidMount() {
    ...
    record.admin.adminId = history.location.state.adminId;
    record.admin.fullName = history.location.state.adminName;
    ...
    return (
      <React.Fragment>
        <div
          ...
          id={"viewEmployeeModal-" + employee.id}
          tabIndex="-1"
          role="dialog"
          data-backdrop="static"
          aria-labelledby={"viewEmployeeModalTitle-" + employee.id}
          aria-hidden="true"
        >
          <div
            ...
            <div className="modal-content">
              <div className="modal-header">
                <h5
                  ...
                  id={"viewEmployeeModalTitle-" + employee.id}
                >
                  Employee Info
                </h5>
                {(!submitted && this.props.connected) || deleted ? (
                  <button
                    id={"btnClose-" + employee.id}
                ...
                <form className="row form-light mx-2 p-4" noValidate>
                  ...
                  <div className="form-group col-lg-6">
                    ...
                    {submitted || deleting || deleted ? (
                      <input
                        ...
                        type="text"
                        name="empFirstName"
                        value={record.empFirstName}
                        noValidate
                        disabled
                      />
                    ) : (
                      <input
                        className={this.inputFieldClasses(errors.empFirstName)}
                        type="text"
                        name="empFirstName"
                        value={record.empFirstName}
                        onChange={this.onChangeRecord}
                  ...
                  <div className="form-group col-lg-6">
                    ...
                    {submitted || deleting || deleted ? (
                      ...
                      <input
                        className={this.inputFieldClasses(errors.empMiddleName)}
                        type="text"
                        name="empMiddleName"
                        value={record.empMiddleName}
                        onChange={this.onChangeRecord}
                  ...
                  <div className="form-group col-lg-6">
                    ...
                    {record.empType === state.empType ? (
                      <input
                        className="form-control"
                        name="empType"
                        value={record.empType}
                        onChange={this.onChangeRecord}
                        noValidate
                        disabled
                      />
                      ...
                      <select
                        className={this.inputFieldClasses(errors.empType)}
                        name="empType"
                        value={record.empType}
                        onChange={this.onChangeRecord}
                        noValidate
                      ...
                      {submitted || deleting || deleted ? (
                        ...
                        <React.Fragment>
                          <input
                            className={
                              "zi-10 " +
                              this.inputFieldClasses(errors.empPassword)
                            }
                            type={passwordState.inputType}
                            name="empPassword"
                            value={record.empPassword}
