...
class ViewAdmission extends Component {
    ...
    getData = () => {
        const { history } = this.props;
        axios.get('https://princemc.heliohost.us/veterinaryClinic/viewTransactionAdmission.php?id='+
    ...
    searchData = searchValue => {
        const { history } = this.props;
        axios.get('https://princemc.heliohost.us/veterinaryClinic/searchTransactionAdmission.php?id='+
