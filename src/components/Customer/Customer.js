    ...
    renderContent = () => {
        ...
        return(
            <React.Fragment>
                ...
                {
                    record.id.length > 0 ?
                    <UpdateAccountInfoModal customer={record} onRefresh={this.onRefresh} /> : null
                }
                <Footer />
            </React.Fragment>
        )
