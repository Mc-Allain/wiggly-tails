...
class Customer extends Component {
            ...
            <div className="col-11 col-sm-10 col-md-8 col-lg-6 form-light my-5">
              <div className="row mx-2 mt-4">
                ...
                <div className="d-flex justify-content-end w-100 my-3">
                  <button
                    className="btn btn-warning w-auto mr-1"
                    onClick={() =>
                      this.onClickLink(
                        "/wiggly-tails/customer/view-transactions"
                      )
                    }
                  >
                  ...
                  <button
                    className="btn btn-secondary w-auto mr-1"
                    onClick={() =>
                      this.onClickLink("/wiggly-tails/customer/manage-pets")
                    }
                  >
                  ...
                  {connected ? (
                    <button
                      ...
                      data-toggle="modal"
                      data-target="#updateAccountInfoModal"
                    >
  ...
  formatHomeAddress = (record) => {
    ...
    homeAddress +=
      record.subdivision.length > 0 ? record.subdivision + ", " : "";
