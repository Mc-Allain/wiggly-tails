...
class UpdateAccountInfoModal extends Component {
    ...
    return (
      <React.Fragment>
        <div
          ...
          id="updateAccountInfoModal"
          tabIndex="-1"
          role="dialog"
          aria-labelledby="updateAccountInfoModalTitle"
          aria-hidden="true"
        >
          <div
          ...
          >
            <div className="modal-content">
              <div className="modal-header">
                <h5 className="modal-title" id="updateAccountInfoModalTitle">
                  Account Info
                </h5>
                {!submitted ? (
                  <button
  ...
  defaultButtons = () => {
    return this.props.connected && !this.state.submitted ? (
      <React.Fragment>
